  ...
  return (
    <div className='profile p-3'>
      <div className="profile-header rounded-2 overflow-hidden">
        ...
        <div className="profile-header-content d-flex flex-column gap-2 bg-white">
          <h2 className='fw-bold'>زياد مصطفي عيد</h2>
      ...
      <div className="profile-content position-relative bg-white mt-3 rounded-2 overflow-hidden">
        ...
        <div className="d-flex flex-wrap justify-content-between align-items-center gap-3 px-5 py-4">
          <h3 className='fw-bold'>طالب</h3>
          <span>تم انشاء هذا الحساب في 11/12/2024, 1:12 AM, منذ 21 ايام</span>
        </div>
        <div className="d-flex flex-wrap align-items-center gap-3 px-5 py-4 text-black">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
